...
{
	/// <summary>
	/// Node object used in <see cref="FilterTreeBox"/>.
	/// </summary>
	/// <seealso cref="Verse.TreeNode" />
	internal class TreeNode_FilterBox : TreeNode
	{
		...
		/// <summary>
		/// Gets or sets whether this node has label and value on separate lines.
		/// </summary>
		public bool SplitRow { get; set; }

		/// <summary>
		/// Gets or sets a value indicating whether the label is hidden.
		/// </summary>
